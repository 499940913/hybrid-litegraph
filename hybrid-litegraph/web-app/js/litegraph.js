...
(function(global) {
    ...
    var LiteGraph = (global.LiteGraph = {
        ...
        registerNodeType: function(type, base_class) {
            ...
            const pos = type.lastIndexOf(LiteGraph.category_splitter);
        ...
        */
        ...
        wrapFunctionAsNode: function(
            ...
            classobj.title = name.split(LiteGraph.category_splitter).pop();
            ...
            if (files && files.length) {
                for (var i = 0; i < files.length; i++) {
                    ...
                    if (node.onDropData) {
                        ...
                        //read data
                        var type = file.type.split(LiteGraph.category_splitter)[0];
                        if (type == "text" || type == "") {
    ...
    LGraphCanvas.prototype.processContextMenu = function(node, event) {
        ...
        if (slot) {
            ...
            if (node.getSlotMenuOptions) {
                ...
                if (!_slot.nameLocked&&node.enableSlotRename){
